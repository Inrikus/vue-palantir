...
const FALLBACK_ICON = '/wiki/fallback/core_missing.png'
function iconSrc (core) {
  const name = core?.Icon
  if (!name) return FALLBACK_ICON
  return `/wiki/Cores/${name}.png`
}
        ...
        >
          <div class="absolute inset-0 overflow-hidden">
            <img
              ...
              draggable="false"
            />
            <img class="w-full h-full object-contain relative z-10" :src="iconSrc(core)" alt="" loading="lazy" draggable="false" @error="handleImgError" />
            <img
